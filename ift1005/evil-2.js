...
`;
        var markup = document.documentElement.innerHTML.split("<script")[0];
          window.onload = function() {
              var matches_original =original.includes(markup[0,markup.length-1]);
              if (!matches_original) {
                  document.body.parentNode.innerHTML = "<p> ATTENTION, tu n'as PAS le droit modifier le HTML. S'il te plaît, remet le comme il l'était avant:)</p>";
              }
          }
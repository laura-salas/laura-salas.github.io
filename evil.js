...
window.onload = function() {
    ...
    if (count_styles_d < 1) {
        document.body.parentNode.innerHTML = "<p> ATTENTION, tu as enlevé le CSS obligatoire du devoir (celui dans le <head> de l'enoncé), s'il te plaît remets-le avant de continuer!";
    }
    else if (count_styles_a + count_styles_b > 0 || count_styles_c > 1) {
